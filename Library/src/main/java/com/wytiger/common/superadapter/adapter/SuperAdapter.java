package com.wytiger.common.superadapter.adapter;
...
import com.wytiger.common.superadapter.LayoutDataWrapper;
import com.wytiger.common.superadapter.SuperViewHolder;
...
public class SuperAdapter extends RecyclerView.Adapter<SuperViewHolder> {
    ...
    //设置数据源
    public void setData(List<LayoutDataWrapper> list) {
        this.items = list;
