package com.wytiger.lib.widget.tagview;
...
public class Tag {
    ...
    private void init(String id, String text, int tagTextColor, float tagTextSize, int layout_color, int layout_color_press, boolean isDeletable, int deleteIndicatorColor,
