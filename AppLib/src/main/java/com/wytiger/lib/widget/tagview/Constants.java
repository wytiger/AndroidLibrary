...
public class Constants {
    ...
    public static final int DEFAULT_TAG_LAYOUT_COLOR = Color.parseColor("#F2f2f2");
    public static final int DEFAULT_TAG_LAYOUT_COLOR_PRESS = Color.parseColor("#FFD9E9");
